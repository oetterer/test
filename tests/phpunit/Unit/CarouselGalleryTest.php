			...
			'simple' => [
				...
				[
					0 => '<div class="carousel slide firefly" style="float:space" id="youcanttakethesky" data-ride="carousel">' . PHP_EOL
						...
						. "\t". '<div class="item active">[[File:Mal.jpg|Malcolm Reynolds|alt=(alt) Malcolm Reynolds]]</div>' . PHP_EOL
						. "\t". '<div class="item">[[File:Wash.jpg|Hoban Washburne|link=/List_of_best_Pilots_in_the_Verse]]</div>' . PHP_EOL
						. "\t". '<div class="item">[[File:MirandaSecretFiles.pdf|(c) by Hands of Blue|page=13|float=none]]</div>' . PHP_EOL
